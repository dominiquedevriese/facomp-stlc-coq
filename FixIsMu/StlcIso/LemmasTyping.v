...
Ltac crushTypingMatchH :=
  match goal with
    ...
    | H: ⟪ _ ⊢ fold_ _ : _ ⟫ |- _ => inversion H; clear H
    | H: ⟪ _ ⊢ unfold_ _ : _ ⟫ |- _ => inversion H; clear H
    ...
    | [ |- ⟪ _ ⊢ fold_ _ : _ ⟫                  ] => econstructor
    | [ |- ⟪ _ ⊢ unfold_ _ : _ ⟫                ] => econstructor
    ...
    | [ |- ⟪ ⊢ pfold _ : _ , _ → _ , _ ⟫ ] => econstructor
    | [ |- ⟪ ⊢ punfold _ : _ , _ → _ , _ ⟫ ] => econstructor
  end.
