...
Section OfType.
  ...
  Lemma OfType_lambda {τ₁ τ₂ τ₁' tsb tub} :
    τ₁' = repEmul τ₁ →
    I.Typing I.empty (I.abs (fxToIs τ₁) tub) (I.tarr (fxToIs τ₁) (fxToIs τ₂)) →
    ⟪ empty ⊢ F.abs (repEmul τ₁) tsb : repEmul τ₁ ⇒ repEmul τ₂ ⟫ →
    OfType (ptarr τ₁ τ₂) (F.abs τ₁' tsb) (I.abs (fxToIs τ₁) tub).
  Proof. crush. Qed.
